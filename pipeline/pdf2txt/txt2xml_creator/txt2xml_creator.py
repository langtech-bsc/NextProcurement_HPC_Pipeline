...
def process_doc(doc_input_path, doc_output_path):
    ...
    with open(doc_input_path, 'r') as doc_fin:
        ...
        with open (doc_output_path, "wb") as fout : 
            tree.write(fout) 
...
# TODO ADD TYPE TO HEADING INDICATING CATEGORY WHEN ITS POSSIBLE